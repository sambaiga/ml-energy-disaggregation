...
each reaching one customer, dozens of them on a real feeder. Left side of
@fig-grid-centralized-decentralized: this chain has moved power exactly one
way for decades, plant to customer, no exceptions.
...
a set of equations. A solved circuit holds more than bus voltages, and
`Circuit` turns every element into a plain Python iterator, no manual
